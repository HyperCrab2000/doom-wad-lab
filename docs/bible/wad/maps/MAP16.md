...
**MAP16** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP16` |
| Official name | Map 16 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP16` |
...
Use the Layers panel or programmatic presets on **MAP16**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map16-all.png`
