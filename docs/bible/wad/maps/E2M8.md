# Map deep dive — E2M8 (Tower of Babel)
...
**E2M8** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `E2M8` |
| Official name | Tower of Babel |
| Notes | Cyberdemon arena |
| Gold snapshot key | `bspGoldenSnapshots.json` → `E2M8` |
...
Use the Layers panel or programmatic presets on **E2M8**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/e2m8-all.png`
