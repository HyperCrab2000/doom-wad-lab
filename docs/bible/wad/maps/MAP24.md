...
**MAP24** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP24` |
| Official name | Map 24 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP24` |
...
Use the Layers panel or programmatic presets on **MAP24**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map24-all.png`
