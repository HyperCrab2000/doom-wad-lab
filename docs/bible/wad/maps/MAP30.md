...
**MAP30** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP30` |
| Official name | Map 30 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP30` |
...
Use the Layers panel or programmatic presets on **MAP30**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map30-all.png`
