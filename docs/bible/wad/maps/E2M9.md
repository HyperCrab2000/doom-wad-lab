# Map deep dive — E2M9 (Fortress of Mystery)
...
**E2M9** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `E2M9` |
| Official name | Fortress of Mystery |
| Notes | Secret |
| Gold snapshot key | `bspGoldenSnapshots.json` → `E2M9` |
...
Use the Layers panel or programmatic presets on **E2M9**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/e2m9-all.png`
