...
**MAP22** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP22` |
| Official name | Map 22 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP22` |
...
Use the Layers panel or programmatic presets on **MAP22**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map22-all.png`
