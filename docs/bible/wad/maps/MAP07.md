...
**MAP07** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP07` |
| Official name | Map 07 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP07` |
...
Use the Layers panel or programmatic presets on **MAP07**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map07-all.png`
