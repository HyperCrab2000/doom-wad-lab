...
**MAP26** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP26` |
| Official name | Map 26 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP26` |
...
Use the Layers panel or programmatic presets on **MAP26**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map26-all.png`
