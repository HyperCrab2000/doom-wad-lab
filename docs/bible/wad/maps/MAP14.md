...
**MAP14** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP14` |
| Official name | Map 14 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP14` |
...
Use the Layers panel or programmatic presets on **MAP14**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map14-all.png`
