...
**MAP20** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP20` |
| Official name | Map 20 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP20` |
...
Use the Layers panel or programmatic presets on **MAP20**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map20-all.png`
