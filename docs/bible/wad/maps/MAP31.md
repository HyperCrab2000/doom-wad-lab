...
**MAP31** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP31` |
| Official name | Map 31 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP31` |
...
Use the Layers panel or programmatic presets on **MAP31**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map31-all.png`
