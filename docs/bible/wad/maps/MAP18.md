...
**MAP18** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP18` |
| Official name | Map 18 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP18` |
...
Use the Layers panel or programmatic presets on **MAP18**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map18-all.png`
