...
**MAP06** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP06` |
| Official name | Map 06 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP06` |
...
Use the Layers panel or programmatic presets on **MAP06**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map06-all.png`
