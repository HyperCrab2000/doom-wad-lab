# Map deep dive — E2M5 (Command Center)
...
**E2M5** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `E2M5` |
| Official name | Command Center |
| Notes | Courtyard visibility |
| Gold snapshot key | `bspGoldenSnapshots.json` → `E2M5` |
...
Use the Layers panel or programmatic presets on **E2M5**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/e2m5-all.png`
