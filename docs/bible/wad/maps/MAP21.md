...
**MAP21** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP21` |
| Official name | Map 21 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP21` |
...
Use the Layers panel or programmatic presets on **MAP21**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map21-all.png`
