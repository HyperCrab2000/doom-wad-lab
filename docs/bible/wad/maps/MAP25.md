...
**MAP25** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP25` |
| Official name | Map 25 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP25` |
...
Use the Layers panel or programmatic presets on **MAP25**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map25-all.png`
