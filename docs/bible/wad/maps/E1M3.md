# Map deep dive — E1M3 (Toxin Refinery)
...
**E1M3** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `E1M3` |
| Official name | Toxin Refinery |
| Notes | Outdoor courtyard sky |
| Gold snapshot key | `bspGoldenSnapshots.json` → `E1M3` |
...
Use the Layers panel or programmatic presets on **E1M3**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/e1m3-all.png`
