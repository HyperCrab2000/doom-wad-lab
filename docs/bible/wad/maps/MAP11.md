...
**MAP11** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP11` |
| Official name | Map 11 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP11` |
...
Use the Layers panel or programmatic presets on **MAP11**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map11-all.png`
