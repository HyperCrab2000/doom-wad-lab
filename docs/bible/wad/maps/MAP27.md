...
**MAP27** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP27` |
| Official name | Map 27 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP27` |
...
Use the Layers panel or programmatic presets on **MAP27**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map27-all.png`
