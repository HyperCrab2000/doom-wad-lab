# Map deep dive — E2M7 (Spawning Vats)
...
**E2M7** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `E2M7` |
| Official name | Spawning Vats |
| Notes | Monster closets |
| Gold snapshot key | `bspGoldenSnapshots.json` → `E2M7` |
...
Use the Layers panel or programmatic presets on **E2M7**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/e2m7-all.png`
