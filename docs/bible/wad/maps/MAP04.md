...
**MAP04** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP04` |
| Official name | Map 04 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP04` |
...
Use the Layers panel or programmatic presets on **MAP04**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map04-all.png`
