...
**MAP19** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP19` |
| Official name | Map 19 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP19` |
...
Use the Layers panel or programmatic presets on **MAP19**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map19-all.png`
