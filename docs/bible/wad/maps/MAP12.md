...
**MAP12** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP12` |
| Official name | Map 12 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP12` |
...
Use the Layers panel or programmatic presets on **MAP12**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map12-all.png`
