...
**E2M3** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `E2M3` |
| Official name | Refinery |
| Notes | Vertical variation |
| Gold snapshot key | `bspGoldenSnapshots.json` → `E2M3` |
...
Use the Layers panel or programmatic presets on **E2M3**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/e2m3-all.png`
