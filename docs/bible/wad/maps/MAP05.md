...
**MAP05** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP05` |
| Official name | Map 05 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP05` |
...
Use the Layers panel or programmatic presets on **MAP05**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map05-all.png`
