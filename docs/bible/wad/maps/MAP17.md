...
**MAP17** is part of the **68-map gold corpus**. Spawn-frame `ref.png` from GZDoom GLES is the pixel oracle for this level.

| Field | Value |
|-------|-------|
| Map ID | `MAP17` |
| Official name | Map 17 |
| Notes | Doom II stock level |
| Gold snapshot key | `bspGoldenSnapshots.json` → `MAP17` |
...
Use the Layers panel or programmatic presets on **MAP17**:
...
Screenshot corpus template: `docs/bible/classic-layers/screenshots/map17-all.png`
