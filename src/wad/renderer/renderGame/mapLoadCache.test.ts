...
describe('mapLoadCache', () => {
  it('builds stable cache keys from wad path and map name', () => {
    expect(mapLoadCacheKey('/wads/DOOM.WAD', 'E1M1')).toBe('v21::play::color::full::/wads/DOOM.WAD::E1M1');
    expect(mapLoadCacheKey(null, 'MAP01')).toBe('v21::play::color::full::memory::MAP01');
    expect(mapLoadCacheKey(undefined, 'MAP01')).toBe('v21::play::color::full::memory::MAP01');
    expect(mapLoadCacheKey('/wads/DOOM.WAD', 'E1M1', false, true)).toBe(
      'v21::play::index::full::/wads/DOOM.WAD::E1M1',
    );
    expect(mapLoadCacheKey('/wads/DOOM.WAD', 'E1M1', true)).toBe(
      'v21::parity::index::full::/wads/DOOM.WAD::E1M1',
    );
    expect(mapLoadCacheKey('/wads/DOOM.WAD', 'E1M1', false, true, true)).toBe(
      'v21::play::index::gzcore::/wads/DOOM.WAD::E1M1',
    );
  });
