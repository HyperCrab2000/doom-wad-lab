...
function skyPillarMap(): WadMap {
  return {
    VERTEXES: [{ x: 0, y: 0 }, { x: 128, y: 0 }],
    SECTORS: [
      { floorheight: 64, ceilingheight: 264, floorpic: 'FLAT4', ceilingpic: 'F_SKY1', lightlevel: 255, type: 0, tag: 0 },
      { floorheight: 64, ceilingheight: 64, floorpic: 'FLAT4', ceilingpic: 'F_SKY1', lightlevel: 255, type: 0, tag: 0 },
    ],
    SIDEDEFS: [
      { xOffset: 0, yOffset: 0, topTexture: '-', bottomTexture: 'CEMENT9', midTexture: '-', sector: 0 },
