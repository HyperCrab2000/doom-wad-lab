...
import { BlockMap } from '@/wad/interfaces/BlockMap';
import { Vertex } from '@/wad/interfaces/Vertex';
import { Node } from '@/wad/interfaces/Node';
import { Sector } from '@/wad/interfaces/Sector';
import { Segment } from '@/wad/interfaces/Segment';
import { SSector } from '@/wad/interfaces/SSector';
...
function extractSectors(lumpDataReader: ByteReader) {
...
function extractSidedefs(lumpDataReader: ByteReader) {
...
function extractLinedefs(lumpDataReader: ByteReader, isExtended: boolean) {
...
function extractSSectors(lumpDataReader: ByteReader) {
...
function extractNodes(lumpDataReader: ByteReader) {
...
function extractSegments(lumpDataReader: ByteReader) {
